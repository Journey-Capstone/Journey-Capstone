...
INSERT INTO books (author, description, google_url, image, isbn, language, page_count, published_date, title)
VALUES ('Anne Rice', 'When Ashlar learns that another Taltos has been seen, he is suddenly propelled into the haunting world of the Mayfair family, the New Orleans dynasty of witches forever besieged by ghosts, spirits, and their own dizzying powers. For Ashlar knows this powerful clan is intimately linked to the heritage of the Taltos.','https://books.google.com/books?id=0YLSIgQsIUAC&dq=Lasher&source=gbs_similarbooks', './content.png', 9780307575920, 'English', 576, 2010, 'Taltos');
